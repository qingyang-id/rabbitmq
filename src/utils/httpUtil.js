...
class HttpUtil {
  ...
  static async send(opts) {
    ...
    if (opts.agentClass) sendOpts.agentClass = opts.agentClass;
    if (opts.agentOptions) sendOpts.agentOptions = opts.agentOptions;
    console.log('request params: ', JSON.stringify(sendOpts));
